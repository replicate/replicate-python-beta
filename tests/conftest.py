...
from replicate import Replicate, AsyncReplicate, DefaultAioHttpClient
from replicate._utils import is_dict
...
logging.getLogger("replicate").setLevel(logging.DEBUG)
